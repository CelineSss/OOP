...
public class ResidentProfilePanel extends JPanel {
    ...
    public ResidentProfilePanel(String residentId) {
    ...
    private void initComponents() {
        ...
        gbc.weightx = 0;
        JLabel idLabel = createStyledLabel("Resident ID:");
    ...
    private JTextField createStyledTextField() {
        ...
        field.setPreferredSize(new Dimension(250, 35)); // Set fixed size
        return field;
    }
    ...
    private void loadUserData() {
        try {
            ...
            if (resident != null) {
                userIdField.setText(resident.getUserId());
    ...
    private void saveButtonActionPerformed() {
        ...
        if (!userId.startsWith("TP")) {
            JOptionPane.showMessageDialog(this,
                "Invalid Resident ID format. Must start with 'TP'",
                "Validation Error",
                JOptionPane.ERROR_MESSAGE);
            return;
        }
