...
public class StaffDashboardPanel extends JPanel {
    ...
    public StaffDashboardPanel(String staffId) {
    ...
    private JPanel createHeaderPanel() {
        ...
        // Welcome text
        JLabel welcomeLabel = new JLabel("Welcome to Staff Menu");
    ...
    private JPanel createMainPanel() {
        ...
        JButton[] buttons = {
            ...
            createStyledButton("Make Payment", "💰", 250, 250),
            createStyledButton("Generate Receipt", "📄", 250, 250),
            createStyledButton("Hostel Information", "🏠", 250, 250),
            createStyledButton("Rules & Regulations", "📜", 250, 250),
            createStyledButton("", "", 250, 250) // Empty button for grid symmetry
        };

        // Hide the last button since we don't need it
        ...
        buttons[0].addActionListener(e -> {
            ...
            if (window instanceof JFrame) {
                ...
                ((JFrame) window).getContentPane().add(new StaffProfilePanel(staffId));
